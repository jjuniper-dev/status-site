    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <p style={styles.description}>
          ...
          Color = R/A/G Status. Hover on Cohere (red bubble, center-right) for details.
        </p>
      </div>
      ...
      <div style={styles.legend}>
        ...
        <div style={styles.legendGroup}>
          <h3 style={styles.legendTitle}>Axes</h3>
          <p style={styles.legendText}>
            <strong>Openness:</strong> Model weights (closed ↔ open) + inference runtime (vendor ↔ self-hosted) + licence type.
          </p>
          <p style={styles.legendText}>
            <strong>Sovereignty:</strong> Corporate control + weights origin + hosting + capital — assessed independently, not as binary.
          </p>
        </div>

        <div style={styles.legendGroup}>
          <h3 style={styles.legendTitle}>Cohere Case Study</h3>
          <p style={styles.legendText}>
            Position (45, 65) = mixed openness (Command proprietary, Aya open) + strong sovereignty (Canadian entity, Canadian-trained weights). 
            Score 58.5 is Amber numerically but Red due to gate overrides (G2 Protected B, G3 SA&A). <strong>Hover on red bubble for details.</strong>
          </p>
        </div>
      </div>
    </div>
